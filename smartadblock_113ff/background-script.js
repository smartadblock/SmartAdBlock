...
function dep_getparenturl(detail){
...
function treatreqexception(txt,inc=false){
	...
	if(txt.includes("||")){
		...
		if(inc){reqforceinclude.push(splitarr[0]);}
...
function make_req_rules(easy_arr){
	...
	for (var i = 0; i < ne; i++) {
		...
		if(b=="css"){
			...
			if(origtxt.includes("imasdk") && origtxt.includes("cbsnews")){track=true;}
