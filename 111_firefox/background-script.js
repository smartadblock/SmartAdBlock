...
if(loaderc%3==0){browser.browserAction.setBadgeText({text: '>--'});}
if(loaderc%3==1){browser.browserAction.setBadgeText({text: '->-'});}
if(loaderc%3==2){browser.browserAction.setBadgeText({text: '-->'});}
loaderc=loaderc+1;
 }, 200);
...
var addff='https://www.trafiklite.com/smartadblock/filters/sabfilter_3.txt';
